...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="px-6 md:px-16 lg:px-24 py-24 min-h-screen flex flex-col justify-center">
      <motion.div
        ref={ref}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mt-12">
          ...
          <div className="flex gap-6">
            {['Twitter', 'Instagram', 'LinkedIn', 'Dribbble'].map(social => (
              <a
                key={social}
                href="#"
                className="text-xs font-mono tracking-[0.15em] text-foreground/30 hover:text-foreground transition-colors editorial-link"
              >
                {social}
              </a>
            ))}
        ...
        >
          <div>
            <label className="text-[10px] font-mono tracking-[0.2em] text-foreground/30 uppercase block mb-2">
              Name
            </label>
            <input
              type="text"
              ...
              className="w-full bg-transparent border-b border-foreground/20 py-3 text-foreground font-mono text-sm focus:border-accent focus:outline-none transition-colors"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-transparent border-b border-foreground/20 py-3 text-foreground font-mono text-sm focus:border-accent focus:outline-none transition-colors resize-none"
              rows={4}
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="px-8 py-4 bg-foreground text-background font-mono text-sm tracking-[0.15em] uppercase hover:bg-accent transition-colors"
          >

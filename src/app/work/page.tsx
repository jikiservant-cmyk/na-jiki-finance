    ...
    switch (category) {
        ...
        return (
          <motion.svg viewBox="0 0 100 100" className="w-24 h-24 md:w-32 md:h-32">
            ...
            <motion.line
              ...
              stroke="oklch(0.13 0 0)" strokeWidth="2"
      ...
      case 'Packaging':
        return (
          <motion.svg viewBox="0 0 100 100" className="w-24 h-24 md:w-32 md:h-32">
            ...
            />
            <motion.rect
              x="35" y="50" width="30" height="10" rx="2" fill={color}
              initial={{ opacity: 0 }}
      ...
      case 'Posters':
        return (
          <motion.svg viewBox="0 0 100 100" className="w-24 h-24 md:w-32 md:h-32">
            <motion.text
              x="50" y="65" textAnchor="middle" fill={color}
              fontSize="60" fontWeight="900" fontFamily="var(--font-geist-sans)"
...
function ProjectSpread({ project, index }: { project: ProjectData; index: number }) {
  const ref = useRef(null)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16 mt-8">
          <div className="lg:col-span-5 flex flex-col items-start gap-8">
            <div
              ...
              style={{ backgroundColor: (project.colorPrimary || '#000') + '15' }}
            >
              <LogoAnimation category={project.category} color={project.colorSecondary || '#fff'} />
              ...
              {[
                ...
                <div key={swatch.label} className="flex items-center gap-2">
                  <div
                    ...
                    style={{ backgroundColor: swatch.color || '#333' }}
                  />
        ...
        <div className="px-6 md:px-16 lg:px-24 pt-24 pb-8">
          ...
          >
            ...
            <p className="text-lg text-foreground/50 mt-4 max-w-md">
              Brand systems, packaging, posters, and type design. Each project treated as a printed spread.
            </p>
          </motion.div>
        </div>
